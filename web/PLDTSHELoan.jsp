                ...
                <section>
                    <table> 
                        <tr>
                            ...
                            <th style="border: 1px solid;">QOH</th>
...
<!--                    <c:forEach var="item" items="${applicationScope.loanitems}"> // Access list of Loan Items from
                        ...
                        <tr>
                            <td align="left">
<!--                                ${item.code} // loanitem Code-->
                            </td>
                            <td algin="left">
<!--                                ${item.description} // loanitem Description-->
                            </td>
                            <td align="right">
                            ...
                            <td align="right">
                                <c:if test="${item.quantity >= 1}">
                                    <a href="<c:url value="PLDTSHCart?action=reserve&code=${item.code}" />">
                                        Reserve</a>
                                    </c:if>
                                    <c:if test="${item.quantity < 1}">
                                    N/A
